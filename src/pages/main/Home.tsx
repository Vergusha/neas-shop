  ...
  return (
    <div className="flex flex-col">
      <main className="container flex-grow px-4 mx-auto sm:px-6 lg:px-8">
        ...
        <section className="py-6 rounded-lg md:py-8 bg-base-200">
          <div className="px-4 md:px-8">
            <h2 className="mb-3 text-xl font-bold sm:text-2xl md:mb-4">Categories</h2>
            <CategoryList />
          </div>
        </section>
        
        <section className="py-6 mb-4 md:py-8">
          <h2 className="mb-3 text-xl font-bold sm:text-2xl md:mb-4">Popular Products</h2>
          {loading ? (
            <div className="flex justify-center">
              <span className="loading loading-spinner loading-lg"></span>
            </div>
          ) : (
            <div className="relative popular-products-container">
              <button
              ...
              <div
                ref={productRowRef}
                className="flex flex-row px-2 pb-4 overflow-x-auto flex-nowrap product-row hide-scrollbar"
              >
                {popularProducts.length > 0 ? (
                  popularProducts.map(product => (
                    <div key={product.id} className="flex-shrink-0 w-full px-2 sm:w-1/2 md:w-1/3 lg:w-1/4">
