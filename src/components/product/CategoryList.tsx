...
const CategoryList: React.FC = () => {
  ...
  const categories = [
    { name: 'Mobile Phones', path: '/mobile', icon: <FaMobileAlt className="mb-2 text-3xl" /> },
    { name: 'Laptops', path: '/laptops', icon: <FaLaptop className="mb-2 text-3xl" /> },
    { name: 'Gaming', path: '/gaming', icon: <FaGamepad className="mb-2 text-3xl" /> },
    { name: 'TV & Audio', path: '/tv-audio', icon: <FaTv className="mb-2 text-3xl" /> },
  ];
