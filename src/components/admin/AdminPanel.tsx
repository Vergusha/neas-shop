...
import UpdateSearchKeywordsButton from '../admin/UpdateSearchKeywordsButton';
...
const AdminPanel: React.FC = () => {
  ...
  return (
    <div className={`p-4 rounded-lg shadow-md ${currentTheme === 'dark' ? 'bg-gray-800 text-gray-200' : 'bg-white text-gray-800'}`}>
